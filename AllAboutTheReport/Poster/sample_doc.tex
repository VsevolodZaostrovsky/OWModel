...
\usepackage[scale=0.65, size=custom, width=84, height=64]{beamerposter} 
\usetheme{vegaposter} 
...
\begin{frame}[t]
    ...
    \begin{block}{Discrete optimal execution strategy}
        \begin{alertblock}
        The solution to the optimal execution problem \eqref{oEproblem} is
        \begin{equation*}
        ...
        \begin{align*}
            ...
            & \gamma_n =   \gamma{n+1} e^{- 2 \rho \tau} - \frac{1}{4} \delta _{n+1} (1 - \beta _{n+1} e^{- \rho \tau} + 2 \gamma _{n+1} \kappa e^{- 2 \rho \tau})^2,
